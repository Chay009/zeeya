...
describe("DOPBankParser", () => {
  ...
  it("Credit message 1", () => {
    ...
    expect(result?.amount).toBe(5550.0);
    expect(result?.currency).toBe("INR");
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(40000.0);
  ...
  it("Credit message 2", () => {
    ...
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(37500.0);
  ...
  it("Credit message 3", () => {
    ...
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(32000.0);
  ...
  it("Credit message 4", () => {
    ...
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(26000.0);
  ...
  it("Credit message 5", () => {
    ...
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(20900.0);
  ...
  it("Credit message 6", () => {
    ...
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(15500.0);
  ...
  it("Credit message 7", () => {
    ...
    expect(result?.type).toBe("INCOME");
    expect(result?.accountLast4).toBe("1234");
    expect(result?.balance).toBe(9990.0);
